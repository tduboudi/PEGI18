...
TRAIN_DIR=/tmp/fear-models/inception_v3

# Where the dataset is saved to.
DATASET_DIR=/home/p3a3_1718/data/records
...
/opt/tensorflow/1.4/bin/python3.5 train_image_classifier.py \
  --train_dir=${TRAIN_DIR} \
  --dataset_name=fear \
...
# Run evaluation.
/opt/tensorflow/1.4/bin/python3.5 eval_image_classifier.py \
